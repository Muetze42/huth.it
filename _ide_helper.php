...
')
     ...
     */ 
         ...
         * 
         *
         * @throws Http\Exceptions\MissingParameter
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function getReportDomain()
        {
                        return \Spatie\FlareClient\Flare::getReportDomain();
        }
                    /**
         * 
         *

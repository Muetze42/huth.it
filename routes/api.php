...
use App\Http\Controllers\Api\Consumer\ConfigController;
...
Route::middleware('auth:consumer-api')->group(function () {
    ...
    Route::get('configs', [ConfigController::class, 'index'])->name('consumer.configs.index');
    Route::get('configs/{config}', [ConfigController::class, 'protectedShow'])->name('consumer.configs.show');
});

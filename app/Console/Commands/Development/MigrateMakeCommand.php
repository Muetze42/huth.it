...
class MigrateMakeCommand extends GeneratorCommand
{
     ...
     * @return $this
     */
    protected function replaceNamespace(&$stub, $name): MigrateMakeCommand
    {
        $replaces = [
            '{{table}}' => $this->table,
            '{{snake0}}' => $this->snake0,
    ...
    {
        if (file_exists(base_path('stubs/migration.pivot.stub'))) {
            return base_path('stubs/migration.pivot.stub');
        }

        return __DIR__.'/../../stubs/migration.pivot.stub';
    }
